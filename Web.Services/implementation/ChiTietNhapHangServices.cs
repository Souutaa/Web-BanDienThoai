...
namespace Web.Services.implementation
{
    public class ChiTietNhapHangServices : IChiTietNhapHangServices
    {
        ...
        public ChiTietNhapHang GetbyID_sp(string id,string id_sanpham)
        {
            return _context.ChiTietNhapHang.Where(x => x.Id_NhapHang == id).Where(x => x.Id_SanPham == id_sanpham).FirstOrDefault();
        }
